...
- From any selected activity, the user can **drill through** to three **Running Activity Details** pages:
  ...
  ![Activity Segments](png/Activity_Segments.png)
...
![Local Legends](png/Local_Legends.png)
...
1. **Segment Overview**  
![Segment Details](png/Segment_Details.png)
...
![Segment Efforts](png/Segment_Efforts.png)
...
- KPI tile with **% of time in Zone 2** and comparison vs previous selected period.  
- Breakdown of time spent in **Z1–Z5 zones** within selected period.  
- **Weekly effort vs 3-week average range** chart to monitor if weekly efforts stays within recommended 3-Week range.  
- Detailed table of recent activities with **relative effort**.

### Yearly Summary

![Yearly Summary](png/Yearly_Summary.png)
...
![Period Summary](png/Period_Summary.png)

More detailed **period analysis**:

- **Heatmap** of **monthly totals** for time, distance, count and effort by **year and month**.  
...
![Rewind Page 1](png/Rewind_1.png)

- Side-by-side comparison of **two selected years**.  
...
![Rewind Page 2](png/Rewind_2.png)
